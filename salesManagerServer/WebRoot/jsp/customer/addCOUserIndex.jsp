...
<table class="ui-table-one" cellspacing="2" cellpadding="0" >
	<caption class="mt30">新增客户分配人</caption>
  <tr>
  <td class="ui-table-title">客户：</td>
    <td class="ui-table-heed">
	    ...
	    <input name="customerName" id="customerName" type="text" value="<s:property value="couser.customerName"/>"  
	    	onClick="getCustomer();"  class="easyui-validatebox" required="true" readonly="readonly"/>
    </td>
    
    <td class="ui-table-title">总经理（副）：</td>
    <td class="ui-table-heed">
	    <input name="couser.salegenId" id="salegenId" type="hidden"/>
	    <input name="couser.salegenName" id="salegenName" type="text" onClick="getSalegen();" 
  ...
  <tr>
    ...
    <td class="ui-table-heed">
	    ...
	    <input name="finmanagerName" id="finmanagerName" type="text" onClick="getFinmanager();" 
	    	class="easyui-validatebox" required="true" readonly="readonly"/>
    </td> 
    ...
    <td class="ui-table-heed">
	    ...
	    <input name="userName" id="userName" type="text" onClick="getUser();"  readonly="readonly"  
	    	value="<s:property value="couser.userName"/>" class="easyui-validatebox" required="true" />
    </td> 
  </tr>
</table>
