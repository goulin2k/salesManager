...
<body class="ui-lv2bg">
 ...
 <div class="ui-table ml15">
  <s:form id="linkmanForm" name="linkmanForm" action="customerLinkman!addLinkman" theme="simple" namespace="/" method="post" validate="false">
<table class="ui-table-one" cellspacing="2" cellpadding="0" >
<caption class="mt30">客户联系人信息</caption>
  <tr>
    <td class="ui-table-title">对应客户：</td>
    <td class="ui-table-input-r">
    <input name="linkman.customerId" id="customerId" type="hidden"/>
    <input name="customerName" id="customerName" type="text" onClick="getCustomer();" class="easyui-validatebox" readonly="readonly" required="true"/></td>
