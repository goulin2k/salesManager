...
<body class="ui-lv2bg">
	<div class="ui-content-title"><p><img src="skin/Default/images/ui-content-ico/tree.png" />销售发票列表</p></div>
<div class="ui-table-style1">
	<table  cellspacing="0" cellpadding="0" >
	  <tr class="ui-table-style1-tr1">	   
	    <td class="td2">单据编号</td>
	    <td class="td2">单据类型</td>  
	    <td class="td4">客户</td>
	    <td class="td5">币别</td>  
	    <td class="td3">部门</td>
	    <td class="td4">业务员</td>
	  ...
	  <s:iterator value="saleList" status="dl">
		<tr class="ui-table-style1-tr2">
		  ...
		  <td><a href="<%=basePath %>sale!show?sale.fInterID=<s:property value="fInterID"/>"> 查看 </a> </td>
		</tr>
	  </s:iterator>
	</table>
</div>
