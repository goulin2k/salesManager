...
<body class="ui-lv2bg">
<div class="ui-content-title"><p><img src="skin/Default/images/ui-content-ico/Sell16.png" />公司发文</p></div>
<form id="news" name="news" action="<%=basePath %>dispatch!add" method="post">
<div class="ui-table ml15">
<table class="ui-table-one" cellspacing="2" cellpadding="0" >
   <caption>新增公司发文</caption> 
  <tr>
     <td class="ui-table-title">标题：</td>
     <td><input class="easyui-validatebox" type="text" required="true" name="news.title" validType="maxLength['标题',50]"/></td> 
  </tr> 
   <tr>
  ...
  <tr>
     ...
     <td class="ui-table-select-s"><s:select theme="simple" name="news.status" listKey="key" listValue="value" list="statusMap"/><
  </tr>
</table> 
</div>
<div class="ui-button-big center fl mt10 mb50 ">
<a href="#" onClick="submitNews();">确定</a>
