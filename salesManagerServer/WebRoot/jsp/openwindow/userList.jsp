...
<body class="ui-lv2bg2">
	...
	<nav class="navbar navbar-default" role="navigation">
	    <ul class="nav navbar-nav">
	    	<li class="active"><a href="sUser!userOpenWindowList"><span class="glyphicon glyphicon-refresh"></span>&nbsp;清空查询条件</a></li>
	    	<li class="active"><a href="javascript:this.close();"><span class="glyphicon glyphicon-remove-sign"></span>&nbsp;关闭</a></li>
	    </ul>
	    <form class="navbar-form navbar-right" role="search" id="searchForm" name="searchForm" 
	    		action="<%=basePath %>sUser!userOpenWindowList" method="post">
	      <div class="form-group">
		  	...
		  	<input type="hidden" id="isNotControl" name="isNotControl" value="${isNotControl}" />
