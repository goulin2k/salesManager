	...
	<body class="ui-lv2bg">
		  ...
		  <form class="form-horizontal" id="myform" name="myform" action="process!approval" method="post">
			<table class="ui-table-one" cellspacing="2" cellpadding="0" >
			  <caption class="mt30">车辆维修申请审批</caption>  
			   <% 
			  ...
			  <tr>
			    ...
			    <td>
					${process.ca.plateNumber}
				</td>
				<td  class="ui-table-title">预计维修日期：</td>
			    <td >
			          <s:date name="process.ca.repairTime" format="yyyy-MM-dd" />
			    </td>
			  </tr>
			  <tr>
			    <td  class="ui-table-title">维修费用：</td>
			    <td>
					${process.ca.repairSum}元
				</td>
				<td  class="ui-table-title">金额大写：</td>
			    <td>
			         ${process.ca.uppercase}元
			    </td>
			  </tr>
			  <tr>
			    <td  class="ui-table-title">是否报保险：</td>
			    <td colspan="3">
			          ${process.ca.isInsuranceName}
			    </td>
			  </tr>
			   <tr>
			        <td class="ui-table-title">维修事由：</td>
					<td colspan="3">
						${process.ca.repairComment}
					</td>
			  </tr>
			  			   <tr>
