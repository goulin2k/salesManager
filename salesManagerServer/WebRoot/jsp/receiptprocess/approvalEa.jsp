	...
	<body class="ui-lv2bg">
		  ...
		  <form class="form-horizontal" id="myform" name="myform" action="process!approval" method="post">
			<table class="ui-table-one" cellspacing="2" cellpadding="0" >
			  <caption class="mt30">费用申请审批</caption>  
			   <% 
              ...
              <tr>
			    ...
			    <td colspan="3">
				    ${process.ea.expenseApplicationCode}
				</td>
			  </tr>
			  <tr>
			  ...
			  <tr>
			    ...
			    <td>
					${process.ea.loanSum }元
				</td>
				<td  class="ui-table-title">金额大写：</td>
			    <td>
			          ${process.ea.uppercase }元
			    </td>
			  </tr>
			  <tr>
			        <td  class="ui-table-title">申请日期：</td>
                    <td  colspan="3"><s:date name="process.ea.expenseTime" format="yyyy-MM-dd" /></td>
