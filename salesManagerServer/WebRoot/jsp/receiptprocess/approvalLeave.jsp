	...
	<body class="ui-lv2bg">
		  ...
		  <form class="form-horizontal" id="myform" name="myform" action="process!approval" method="post">
			<table class="ui-table-one" cellspacing="2" cellpadding="0" >
			  <caption class="mt30">休假单审批</caption>  
			  <% 
			  ...
			  <tr>
			    ...
			    <td>
					${process.leave.typeName }
				</td>
				<td  class="ui-table-title">休假天数：</td>
			    <td>
			          ${process.leave.leaveDays }小时
			    </td>
			  </tr>
			  <tr>
			        <td  class="ui-table-title">开始日期：</td>
                    <td><s:date name="process.leave.startTime" format="yyyy-MM-dd" /></td>
                    <td class="ui-table-title">结束日期：</td>
				    <td><s:date name="process.leave.endTime" format="yyyy-MM-dd" /></td>
