...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body class="ui-lv2bg">
	    <div class="ui-content-title"><p><img src="skin/Default/images/ui-content-ico/1.png" />车辆维修报销查看</p></div>
		  ...
		  <div class="ui-table ml15">
			<table class="ui-table-one" cellspacing="2" cellpadding="0" >
			  ...
			  <tr>
			    ...
			    <td>
			        ${cr.repairFactoryPhone}
			    </td>
			  </tr>
			  <tr>
			    <td  class="ui-table-title">维修金额：</td>
			    <td>
					${cr.reimbursementSum}元
				</td>
			  ...
			  <tr>
			    ...
			    <td class="ui-table-title">车辆维修申请单据号：</td>
			    <td colspan="3">
			        ${cr.ca.carApplicationCode}
			    </td>
			  </tr>
