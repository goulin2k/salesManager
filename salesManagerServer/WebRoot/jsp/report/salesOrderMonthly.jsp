...
<script type="text/javascript">
	...
	function deleteSearch() {	//清除查询条件
		window.location.href = basePath + '/report!orderMonthly';
	}
...
<body class="ui-lv2bg">
	...
	<nav class="navbar navbar-default" role="navigation">
	    ...
	    <form class="navbar-form navbar-right form-inline" role="search" 
	    	id="reportForm" name="reportForm" action="<%=basePath %>report!orderMonthly" method="post">
     ...
     <div class="panel-heading crm-table-title"><B>报表统计信息</B></div>
		<table class="table table-hover"  cellspacing="0" cellpadding="0" >
		     <tr class="ui-table-style1-tr2">
                <td>统计日期：</td>
                <td>从<b><s:date name="startTime" format="yyyy-MM"/> </b>
                		到<b><s:date name="endTime" format="yyyy-MM"/></b></td>
                <!-- <td>销售金额合计：</td>
