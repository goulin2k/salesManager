 ...
 *
 */
public class UserTypeDecisionHandler implements DecisionHandler {
	...
	public String decide(OpenExecution exe) {
		...
		if ("后勤部经理".equals(startUser.getPositionBsName())) {
			return "总经理";
		}else if ("副总经理".equals(startUser.getPositionOrgName())) {
			return "后勤部经理";
		}else if ("后勤部经理".equals(parentUser.getPositionBsName())) {
			return "后勤部经理";
		} else {
			return "上级主管";
		}
