 ...
 *
 */
public class TestSaleReport extends com.sales.BaseTestCase {

	private K3OrderStatisticsService service;
	...
	protected void setUp() throws Exception {
		service = (K3OrderStatisticsService) ctx.getBean("k3OrderStatisticsService");
		super.setUp();
	}
	...
	public void testStatByDay() throws ParseException{
		...
		List<K3OrderStatistics> result = service.statByDay(beginDate, endDate, userId);
		logger.info("指定日期区间的业务人员销售业绩日统计：\n------------------------------------------");
		for (Iterator iterator = result.iterator(); iterator.hasNext();) {
			K3OrderStatistics k3OrderStatistics = (K3OrderStatistics) iterator
					.next();
	...
	public void testStatByWeek() throws ParseException{
		...
		List<K3OrderStatistics> result = service.statByWeek(beginDate, endDate, userId);
	...
	public void testStatByMonth() throws ParseException{
		...
		List<K3OrderStatistics> result = service.statByMonth(beginDate, endDate, userId);
